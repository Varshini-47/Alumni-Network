...
<nav className="bg-pink-100 py-6 mt-auto">
        <div className="container mx-auto flex justify-between items-center">
          <div className="flex items-center space-x-2">
            ...
            {/* <span className="text-xl font-semibold">ALUMNI ASSOCIATION</span> */}
  ...
  ALUMNI ASSOCIATION
          ...
          <div className="flex items-center space-x-4">
            ...
            <Link to="/alumni" className="hover:text-green-600">FEATURED ALUMNI</Link>
            ...
            {!(user && user.firstName) ? (
              <div className="space-x-2">
                <Link to="/login" className="px-4 py-2 text-green-500 border border-green-500 rounded">Log In</Link>
              ...
              <div>
                ...
                <Link to={`/profile/${user.id}`} className="px-4 py-2 bg-green-500 text-white rounded">View Profile</Link>
                {/* <Link to="/chat" className="px-4 py-2 bg-green-500 text-white rounded">Chat</Link> */}
                <div>
