              ...
              <div className="flex items-center gap-2">
                ...
                <div className="flex rounded-lg overflow-hidden border border-gray-200">
                  ...
                  <button
                    ...
                    className={`px-3 py-2 text-sm font-medium ${filter === "pending"
                  ...
                  <button
                    ...
                    className={`px-3 py-2 text-sm font-medium ${filter === "resolved"
              ...
              <AnimatePresence>
                {filteredSubmissions.map((submission) => (
                  <motion.div
                    ...
                    className={`bg-white rounded-xl shadow-md overflow-hidden transition-all hover:shadow-lg group ${submission.resolved ? 'border-l-4 border-green-500' : 'border-l-4 border-yellow-500'
                      }`}
                  >
                    <div className="p-6">
