  ...
  const handleProfileTypeChange = async (newType) => {
    ...
    try {
      ...
      if (newType === "PRIVATE") {
        ...
        toast.success(
          "Profile set to public. Your profile is now visible to all users."
        );
      }
    } catch (error) {
        ...
        <div className="bg-white rounded-xl shadow-xl overflow-hidden max-w-md w-full">
          <div className="bg-gradient-to-r from-blue-600 to-indigo-700 p-6 text-white">
            ...
            <p className="mt-2 text-blue-100">
              Access to alumni profiles requires login
            </p>
          </div>
          <div className="p-6">
            <p className="text-gray-600 mb-6">
              Please sign in to your account to view alumni profiles and connect
              with the community.
            </p>
    ...
    return (
      <div className="min-h-screen bg-gradient-to-r from-blue-50 to-indigo-100 flex items-center justify-center p-4">
        <div className="bg-white rounded-xl shadow-lg p-8 max-w-md text-center">
          ...
          <p className="text-gray-600 mb-6">
            The alumni profile you're looking for doesn't exist or may have been
            removed.
          </p>
          <button
            onClick={() => navigate("/")}
      ...
      <div className="min-h-screen bg-gradient-to-r from-blue-50 to-indigo-100 flex items-center justify-center p-4">
        <div className="bg-white rounded-xl shadow-xl overflow-hidden max-w-md w-full text-center">
          ...
          <div className="p-8">
            ...
            <p className="text-gray-600 mb-6">
              This alumni has set their profile to private.
            </p>
            <button
              onClick={() => navigate("/")}
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-xl shadow-lg overflow-hidden border border-gray-200">
              ...
              <div className="h-32 bg-gradient-to-br from-blue-300 to-indigo-500 relative">
                ...
                <div className="absolute top-4 right-4">
                  <div
                    className={`text-xs font-medium px-3 py-1 rounded-full flex items-center ${
                      profileType === "PRIVATE"
          ...
          >
                ...
                {workexp && workexp.length > 0 ? (
                  <div className="space-y-6">
                    {workexp.slice(0, 2).map((exp, index) => (
                      <div
                        key={index}
                        className="group p-4 bg-gray-50 rounded-lg shadow"
                      >
                        ...
                        {index < workexp.slice(0, 2).length - 1 && (
                  ...
                  <div className="space-y-6">
                    {achievements.slice(0, 2).map((achievement, index) => (
                      ...
                      >
                        ...
                        {index < achievements.slice(0, 2).length - 1 && (
                          <hr className="my-4 border-gray-100" />
                        )}
                      </div>
                    ))}
            ...
            {userId == id &&
              (workexp.length > 0 || achievements.length > 0) && (
